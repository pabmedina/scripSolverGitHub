...
poroElasticity = true; checkFaces = false; isipKC = true; %improvePerm = 1; 
flagPreCierre =false; factorAjuste = 1; gapPreCierre = 1; flagCierre = false; gapCierre =3e-1; %1e2
meshCase = 'DFN';%'DFIT'; %'WI';% 
%-------------------------------------------------------------------------%
%% %%%%%%%%%%%%%%%%%%%       main DFIT/TShape       %%%%%%%%%%%%%%%%%%%% %%
%-------------------------------------------------------------------------%
...
nombreCorrida     = ['DFN_tripleEncuentroRawSRV',idCasos]; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.

cargaDatos     = 'load'; % Forma en la que se cargan las propiedades de entrada. "load" "test" "default" "change".
archivoLectura = 'DFITtripleEncuentro_rev052022_062023.txt';%'DFIT_rev052022_WI062023CorridaCorta.txt';%'DFIT_rev052022_WI+DFN062023CorridaCorta.txt';%'Dfit_rev052022_DFIT_062023.txt'; %'Dfit_rev052022_DFIT_WItrial_062023.txt';% Nombre del archivo con las propiedades de entrada. 
...
direccionRestart   = 'D:\Geomec\paper DFN\ITBA\Piloto\DFIT\Resultados de corridas (.mat)\DFN_tripleEncuentroRawSRV6\';
propiedadesRestart = 'resultadosFinISIP_DFN_tripleEncuentroRawSRV6.mat';
...
hold on
plotMeshColo3D(meshInfo.nodes,meshInfo.elements(meshInfo.elementsFisu.ALL.index,:),meshInfo.cohesivos.elements,'on','on','r','r','k',1) % Se plotea la malla
hold off
%%
%-------------------------------------------------------------------------%
%%%                             PARAMETROS                              %%%
