...
elseif strcmpi(key,'change')
    ...
    SRVProperties.key = propiedades{77};
    SRVProperties.dX  = str2num(propiedades{78})*m2mm;
    SRVProperties.dY  = str2num(propiedades{79})*m2mm;
    SRVProperties.dZ  = str2num(propiedades{80})*m2mm;
