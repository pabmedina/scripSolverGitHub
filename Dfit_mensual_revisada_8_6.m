...
nombreCorrida     = 'DFIT_mensual'; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.

cargaDatos     = 'load'; % Forma en la que se cargan las propiedades de entrada. "load" "test" "default" "change".
archivoLectura = 'Dfit_rev052022_DFIT_WI+DFNtrial_062023.txt';%'Dfit_rev052022_DFIT_062023.txt'; %'Dfit_rev052022_DFIT_WItrial_062023.txt';% Nombre del archivo con las propiedades de entrada. 
...
meshInfo.constraintsRelations = normalConstraints(meshInfo.constraintsRelations,meshInfo.nodosBoundary);
...
%-------------------------------------------------------------------------%
% -- Fluidos.
[CTFluidos,nCREqFluidos] = getCTFluidos(meshInfo.CRFluidos,physicalProperties.fluidoFracturante.preCondCTFluidos,paramDiscEle.nDofTot_P,meshInfo);
