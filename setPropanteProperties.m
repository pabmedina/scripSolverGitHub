...
elseif strcmpi(key,'change')
    ...
    propanteProperties.Key         = propiedades{72};
    propanteProperties.EP          = str2num(propiedades{73})*Mpsi2MPa;
    propanteProperties.NuP         = str2num(propiedades{74});
    propanteProperties.kappa_int_P = str2num(propiedades{75})*mDarcy2M2*(mm2m)^2;
    propanteProperties.hP          = str2num(propiedades{76})/100;
