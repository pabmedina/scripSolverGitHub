function [meshInfo,cohesivosProperties] = setCohesivosPropertiesLabel( meshInfo,physicalProperties,temporalProperties,bombaProperties,key,key2,varargin )
...
% la corrida de verificacion o cargar las propiedades de un archivo ya 
% escrito. Para cambiar las propiedades fisicas del problema ingresar como 
% key2.

% key2: "change" "default" "test" "load"

% Para plotear la curva de esfuerzo vs deformacion de los elementos
% cohesivos ingresar como key.

% key: "on" "off"

% Las propiedades se guardan en la estructura "cohesivosProperties" con los
% siguientes campos:
% cohesivosProperties: 
...
elseif strcmpi(key2,'change')
    ...
    if ~isempty(cohesivosProperties.tensionRoturaCohesivoL)
        ...
        while cohesivosProperties.dN0L*10/100 < cohesivosProperties.dN1L % Uno es al menos el 10% del otro. 
            warning('Se aumenta la rigidez del cohesivo LIMESTONE normal para respestar la forma')
        ...
        while cohesivosProperties.dS0_1L*10/100 < cohesivosProperties.dS1_1L
            warning('Se aumenta la rigidez del cohesivo LIMESTONE a corte para respestar la forma')
    ...
    if ~isempty(cohesivosProperties.tensionRoturaCohesivoL)
        ...
        while cohesivosProperties.dN0Inter*10/100 < cohesivosProperties.dN1Inter % Uno es al menos el 10% del otro. 
            warning('Se aumenta la rigidez del cohesivo INTERFACE normal para respestar la forma')
        ...
        while cohesivosProperties.dS0_1Inter*10/100 < cohesivosProperties.dS1_1Inter
            warning('Se aumenta la rigidez del cohesivo INTERFACE a corte para respestar la forma')
