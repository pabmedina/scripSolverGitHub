...
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,1)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','S_x [psi]')
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,2)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','S_y [psi]')
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,3)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','S_z [psi]')
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,4)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','Tau_xy [psi]')
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,5)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','Tau_yz [psi]')
plotElemental(meshInfo.nodes,meshInfo.elements,tensionEfectivaPG(:,:,6)*mPa2psi,'Y','Tensiones Sin Promediar','x [mm]','y [mm]','z [mm]','Tau_xz [psi]')
