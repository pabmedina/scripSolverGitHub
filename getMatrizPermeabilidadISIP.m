function [ Kperm ] = getMatrizPermeabilidadISIP(physicalProperties,meshInfo,SRVProperties,improvePerm,type,key )
...
KpermGP_ISIP   = improvePerm*KpermGP_S;
...
switch type
    ...
    case 'ISIP' 
        ...
        for iEle = 1:nElements
            %             if any(iEle == meshInfo.elementsFisu.ALL.index)
...
if strcmpi(key,'Y') && ~strcmpi(type,'single') && false % Plot para verificar los valores de permeabilidad en el dominio. 
