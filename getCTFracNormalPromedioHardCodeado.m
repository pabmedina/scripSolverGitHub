function [ CTFrac ,nCREqFrac ] = getCTFracNormalPromedioHardCodeado(nodeDofs,constraintsRelations,precondCT,nDofTot_U,meshInfo)
...
iFila                   = 1;
% plotMeshColo3D(nodes,meshInfo.elements,meshInfo.cohesivos.elements,'off','on','w','r','k',1) % Se plotea la malla
% hold on
% scatter3(nodes(constraintsRelationsInt(3,:),1),nodes(constraintsRelationsInt(3,:),2),nodes(constraintsRelationsInt(3,:),3),'k*')
