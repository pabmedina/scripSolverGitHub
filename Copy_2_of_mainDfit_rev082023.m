...
nombreCorrida     = 'DFIT_WI_solverGitHub'; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.
...
if ~keyAgusCheck && (strcmpi(meshCase,'DFN')|| strcmpi(meshCase,'WI'))
