...
nombreCorrida     = 'DFN_tripleEncuentroRaw'; % Nombre de la corrida. La corrida se guarda en la carpeta "Resultado de corridas" en una subcarpeta con este nombre.
...
xPos = 1e4; yPos = 3e4; zPos = 3.4e4; tolFind = 1e-1;
nodTripleEncuentro = findTriple(meshInfo, xPos,yPos,zPos,tolFind);
