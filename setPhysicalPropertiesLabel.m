function [ physicalProperties ] = setPhysicalPropertiesLabel(key,varargin)
...
elseif strcmpi(key,'change')
    ...
    mDarcy2M2 = 9.87e-16;
    m2mm      = 1000;
    physicalProperties.fluidoPoral.kappaIntShale       = varName('permShale', propiedades)             * mDarcy2M2  * (m2mm)^2; %en mm^2
    ...
    physicalProperties.fluidoPoral.kappaS    = physicalProperties.fluidoPoral.kappaIntShale/physicalProperties.fluidoPoral.mu_dinamico; %en [mm^2/(MPa s)] = [mm2 m s/(1e6 kg)] = [m3 s/kg]
