...
elseif strcmpi(key2,'change')
    ...
    %% Shale Properties
    cohesivosProperties.npiCohesivos          = str2num(propiedades{62});
    cohesivosProperties.angDilatancy          = str2num(propiedades{63});
    cohesivosProperties.tensionRoturaCohesivo = str2num(propiedades{64});
    cohesivosProperties.K1c                   = str2num(propiedades{65});
    ...
    cohesivosProperties.K2c                    = cohesivosProperties.K1c/3*3; % El *3 lo agrego para probar.
    ...
    cohesivosProperties.tensionRoturaCohesivoL = str2num(propiedades{66});
    cohesivosProperties.K1cL                   = str2num(propiedades{67});
    ...
    cohesivosProperties.tensionRoturaCohesivoInter = str2num(propiedades{68});
    cohesivosProperties.K1cInter                   = str2num(propiedades{69});
    cohesivosProperties.EvInter                    = str2num(propiedades{70})*Mpsi2MPa;
    cohesivosProperties.NUvInter                   = str2num(propiedades{71});
